...
const AttendanceManagementPage = () => {
  ...
  const isLocked = (isToday && isAfter10PM) || isPastDate;
  ...
  const handleSubmit = async () => {
    ...
    if (isLocked) {
      setError("Attendance is locked. Cannot modify.");
      return;
    }
    ...
    try {
      ...
      // Validation
      const unselected = records.some(r => !r.status);
      if (unselected) {
        setError("Please select status for all students");
        setLoading(false);
        return;
      }
      ...
      <div className="attendance-container">
        ...
        {isLocked && (
          <div className="message-error">
            Attendance cannot be modified for this date
          </div>
        )}
                    ...
                    <td>
                      <div className="status-buttons">
                        ...
                        <button
                          ...
                          disabled={isLocked || (mode === "edit" && !r.editable)}
                        >
                          P
                        </button>
